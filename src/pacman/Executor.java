...
import pacman.QLearning.QLPacMan;
...
{	
	...
	public static void main(String[] args)
	{
        ...
        // uncomment DTPacman to run Decision tree implementation of PacMan
		//exec.runGameTimed(new DTPacman(),new StarterGhosts(),visual);

//        exec.runGameTimed(new StarterPacMan(),new StarterGhosts(),visual);

		exec.runGameTimed(new QLPacMan(),new StarterGhosts(), visual);

        //Uncomment RAPPacMan to run RAP implementation for pacman.
