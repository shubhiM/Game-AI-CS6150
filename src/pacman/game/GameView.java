...
{	
    ...
    private void drawGameInfo()
    {
    	...
    	String place = "(" + game.getNodeXCood(pacman) + ", " + game.getNodeYCood(pacman) + ")";
    	place = place + " " + pacman + " " + game.getPacmanLastMoveMade().toString();
		bufferGraphics.drawString(place,4,231);

//		int mazeIndex = game.getMazeIndex();
//		bufferGraphics.setColor(Color.YELLOW);
//		final Set<Integer> indexes = Game.caches[mazeIndex].junctionIndexConverter.keySet();
//		for (Integer index : indexes) {
//			int x = game.getNodeXCood(index);
//			int y = game.getNodeYCood(index);
//			bufferGraphics.drawString(index.toString(), x * MAG, y * MAG + 12);
//		}
	}
