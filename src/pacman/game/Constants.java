...
public final class Constants
{
	...
	public static final int NUM_LIVES=5;					//total number of lives Ms Pac-Man has (current +
	// NUM_LIVES-1 spares)
	...
	public static final String pathQLearning="data/qL";
	...
	public static final double Q_LEARNING_RATE = 0.3;
	public static final double Q_DISCOUNT_RATE = 0.5;
    public static final double Q_ACTION_RANDOMNESS = 0.1;
